...
const ENVELOPE_RULES = [
  {
    ...
    description: "Requires exactly one ISA interchange header and one IEA interchange trailer in the 835 file.",
    source: "X12 005010",
    severity: "Hold",
  },
  {
    rule_code: "ENV-002",
    segment: "GS/GE",
    rule: "Functional Group Envelope (GS/GE)",
    description: "Requires at least one GS/GE functional group envelope and requires the number of GS and GE segments to match.",
    source: "X12 005010",
    severity: "Hold",
  },
  {
    rule_code: "ENV-004",
    segment: "ST/SE",
    rule: "Transaction Set Envelope (ST/SE)",
    description: "Requires each 835 transaction set to open with ST and close with SE, with balanced ST/SE transaction envelopes.",
    source: "X12 005010",
    severity: "Hold",
  },
  {
  ...
  },
  {
    ...
    description: "Requires SE01 to be numeric and equal the actual number of segments from ST through SE for each transaction.",
    source: "X12 005010",
    severity: "Hold",
  },
  {
    ...
    description: "Requires ST02 and SE02 transaction control numbers to be present and to match for each transaction set.",
    source: "X12 005010",
    severity: "Hold",
  },
];
