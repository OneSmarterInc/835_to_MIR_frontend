...
export default function ResultView({ clients = [], isAdmin = false, initialClientId = "" }) {
  ...
  const loadResults = useCallback(async (requestedPage = 1, requestedSearch = "", requestedSort = { key: "", direction: "asc" }, requestedStatus = "") => {
  ...
  useEffect(() => {
    ...
    const timer = window.setTimeout(() => {
      ...
      setPage(1);
      loadResults(1, value, sort, statusFilter);
    }, 300);
    return () => window.clearTimeout(timer);
  }, [search, sort, statusFilter, loadResults]);
